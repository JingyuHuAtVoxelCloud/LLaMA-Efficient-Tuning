...
CUDA_VISIBLE_DEVICES=3 python ../src/web_demo.py \
    --model_name_or_path /mnt/eye_team/jyhu/Ihin_assets/share/Ihin-v1.1 \
    --template chatglm2 \
    --finetuning_type lora \
    --checkpoint_dir ../outputs/retina_gpt/sft-chatglm2_230919/checkpoint-100