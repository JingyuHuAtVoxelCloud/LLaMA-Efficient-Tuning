...
import sys
sys.path.append('/mnt/eye_team/jyhu/LLaMA-Efficient-Tuning/models/chatglm2-6b')
...
if __name__ == "__main__":
    import json 
    with open("/mnt/eye_team/jyhu/LLaMA-Efficient-Tuning/models/chatglm2-6b/config.json", "r") as file:
